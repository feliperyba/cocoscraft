...
export class CommonDebug extends Component {
    ...
    addDebug() {
        ...
        Debug.addSlider(
            ...
            .addItem('Overdraw Test', this.testOverdraw.bind(this))
            .addList('Image Memory', this.getImageMemory.bind(this))
    ...
    getImageMemory(): string {
        ...
        images.forEach((image, i) => {
            ...
            const url = self.url;
            const num =
                Math.floor(((self.width * self.height * (native.indexOf('jpg') > 0 ? 3 : 4)) / 1024 / 1024) * 10000) /
                10000;
            total += num;
            output = output + '\n' + url + '....' + num + 'M';
        });
